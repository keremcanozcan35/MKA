...
import 'package:flutteragain/character_detail_screen.dart';
            ...
            children: [
              ...
              Align(
                  ...
                  child:Hero(
                    ...
                    child:Image.asset(
                      character.imagePath,
                      height: screenHeight * 0.415 * value,
                    ),)
              ),
              Padding(
                    ...
                    Hero(
                      ...
                      child: Material(
                        ...
                        child: Container(
                          child: Text(
                            character.name,
                            style: ApplicationTheme.heading,
                          ),
                        ),
                      ),
                    ),
                    Text("Daha fazla bilgi için buraya dokun.",style: ApplicationTheme.subHeading,)
                  ],
                ),
              ),
            ],
